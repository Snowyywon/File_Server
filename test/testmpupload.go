...
func main() {
	username := "snowy"
	token := "a0c6c187f780447062143f80bf4e7e93679535b0"
	filehash := "430685d948ba7396c18fa2c68de4fd64f0eb72bd"
	...
	// 3. 请求分块上传接口
	filename := "/home/snowy/go1.23.3.linux-amd64.tar.gz"
	tURL := "http://localhost:8082/file/mpupload/uppart?" +
		"username=snowy&token=" + token + "&uploadid=" + uploadID
